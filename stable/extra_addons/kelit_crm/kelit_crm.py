...
class crm_lead(osv.osv):
    ...
    _columns={   
        ...
        'partner_category_ids' :fields.many2many('res.partner.category', id1='lead_id', id2='category_id', string='Customer Category'),
    ...
    def _lead_create_contact(self, cr, uid, lead, name, is_company, parent_id=False, context=None):
        ...
        if partner_id:
            category_data=[ (4, categ.id) for categ in  lead.partner_category_ids ]
            partner_obj.write(cr,uid,partner_id,{'category_id':category_data} )
